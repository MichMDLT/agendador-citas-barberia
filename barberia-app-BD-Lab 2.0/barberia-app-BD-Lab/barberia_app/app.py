...
print("Colecciones en la base de datos:", db.list_collection_names())  # Opcional: para debug

# --- Insertar una cita de prueba (opcional) ---
if citas.count_documents({}) == 0:  # Solo si la colección está vacía
    citas.insert_one({
    ...
    print("Cita de prueba insertada.")  # Debug
...
servicios = ["Corte clásico", "Corte moderno", "Afeitado", "Tinte", "Arreglo de barba"]
combo_servicio = ttk.Combobox(frame_form, values=servicios, width=27)
...
barberos = ["Carlos", "Luis", "Ana", "Mario"]
combo_barbero = ttk.Combobox(frame_form, values=barberos, width=27)
